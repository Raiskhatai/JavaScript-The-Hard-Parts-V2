...
// A closure is formed when a function retains access to variables from its lexical (outer) scope even after the outer function’s execution context has been removed from the call stack.
// Closure = Function + Lexical Environment captured at the time of function creation

// Functions get a new memory evey run/invoction.

// every time function get executed,run,invoke as an invocation,it creates a brand new local memory.(brand new execution context)
...
// -- When our function get called ,we create a live store for data[local memory/variable enviroment/state ] for that function's execution context.
